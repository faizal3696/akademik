						...
						<div class="login-container">
							...
							<div class="row-fluid" style="margin-top:25%;">
								<div class="position-relative">
									<div id="login-box" class="login-box visible widget-box no-border" style="background-color: none">
										<div class="widget-body">
												...
												<form method="post" action="<?php echo base_url();?>index.php/web/login" onSubmit="return cekform();">
													<fieldset>
														...
														<div class="clearfix">
															...
															<button class="width-35 pull-right btn btn-small btn-primary" style="width:100% !important;">
																<i class="icon-key"></i>
																Login
															</button>
														</div>
											...
											<div class="toolbar clearfix">
												<div>
													<a href="#" onClick="show_box('forgot-box'); return false;" class="forgot-password-link" style="text-decoration: none;">
												...
												<div>
													<a href="#" onClick="show_box('signup-box'); return false;" class="user-signup-link" style="text-decoration: none;">
														Daftar baru
